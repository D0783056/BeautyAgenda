...
String getScore(List<String> c1, List<String> c2, List<String> c3, List<String> c4, List<String> c5, List<String> c6, List<String> c7, List<String> c8) {
  int sum = 0;
  var score = {
    "完全不會": 0,
    "幾乎不會": 1,
  ...
  if((score[c1[0]] + score[c6[0]] + score[c7[0]] + score[c8[0]]) >= 13){
    return 'A';
  } else if((score[c2[0]] + score[c3[0]] + score[c4[0]]) >= 10){
    return 'B';
  } else if((score[c5[0]] + score[c6[0]]) > 7){
    return 'C';
  } else {
    return 'D';
  }
