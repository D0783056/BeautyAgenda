...
class _CommentPageState extends State<CommentPage> {
  ...
  Future saveHistory() async {
    var url = 'http://140.134.26.187/BeautyAgenda/saveHistory.php';
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                Fluttertoast.showToast(
                                  msg: "儲存成功!", backgroundColor: Colors.grey,);
                              },
                              child: Container(
...
Widget displayImg(String imagepath, int isFront) {
  ...
  return Transform(
    ...
    child: Image.file(IO.File(imagepath), width: 300, fit: BoxFit.fill),
